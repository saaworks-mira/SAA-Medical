...
function addheader()  {  
  ...
  var descreport='<thead id="idviewthead"><tr><th class="text-center">Drugid</th><th class="text-center">Drug name</th><th class="text-center">Dt of Trans</th><th class="text-center">Trans Name</th>'+
  '<th class="text-center">Type</th><th class="text-center">Stock Position</th><th class="text-center">Unit Price</th>'+
			'<th class="text-center">op stk</th><th class="text-center">qty trans</th><th class="text-center">cls stk</th><th class="text-center">Total Value</th>transtype</tr><th class="text-center">Total Value</th>Trans time</thead>';
