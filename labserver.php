...
$(document).on('click','#idpatbtnconf', function (e) {	
    if (document.getElementById("idpatinpconf").value == "y" || document.getElementById("idpatinpconf").value == "Y") {
     ...
     $.post("ip_rewrite.php",
       ...
       document.getElementById("idpatmsg").innerHTML = "      Results file created;"
        $("#idfilelink").remove() 
            reportname += '?_=' + (new Date()).getTime();
       var filenm='<h4><a id="idfilelink" href="reports/' + reportname+ '" target="_blank">Click to View Lab Report</a></h4>'
