...
<head>
 ...
 <!-- <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">2505-->
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
  <!--<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>2505-->
...
document.getElementById("idpsw").value =""
...
<div class="container">
  ...
  <h3 class="text-center" style="color: blue"><strong>SRI AUROBINDO ASHRAM PHARMACY RECORD </h3>
...
<div id="idlogin" class="container">
   <form id="idlogform" class="form-horizontal" name="nmlogform" action="auropharmamenu.php" method="post"  role="form">
 ...
 <label class="control-label text-info col-sm-offset-3 col-sm-1" for="idusr">
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login:</label> 
     ...
     <INPUT type ="text" class="form-control" id="idusr" name ="nmusr" >
   ...
   <div class="row">      
     ...
     <div class="col-sm-3 form-group"> 
     <INPUT type ="password" class="form-control" id="idpsw" name ="nmpsw" >
        <div class="help-block with-errors"></div>     
     </div>
   </div>
    ...
    <label class="col-sm-1 control-label"></label>
     <div class="col-sm-2">
    <Input type="button" class="form-control btn btn-success btn-round" name="nmbtnlog" id="idbtnlog"  value= "Log in">
     </div>
    </div>
    </div>
