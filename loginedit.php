...
<div class="container">
  ...
  <h3 class="text-center" style="color: blue"><strong>SRI AUROBINDO ASHRAM IN-PATIENT RECORD </h3>
...
<div id="idlogin" class="container">
   <form id="idlogform" class="form-horizontal" name="nmlogform" action="ip_editadmnew.php" method="post"  role="form">
