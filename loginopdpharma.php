...
<div class="container">
  ...
  <h3 class="text-center" style="color: blue"><strong>SRI AUROBINDO ASHRAM OPD PHARMACY </h3>
...
<div id="idlogin" class="container">
   <form id="idlogform" class="form-horizontal" name="nmlogform" action="ph_opdpharma.php" method="post"  role="form">
