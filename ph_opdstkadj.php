...
<head>
  ...
  <!--<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"> 2305-->
...
// below variables are retunbed from backend and contains all the drugs         
       drugname=fields.drugname; drugid=fields.drugid; drugstrength=fields.drugstrength;  drugtype=fields.drugtype; 
          ...
          filldrugdropdown()    //vikas june 9 2018
...
$(document).ready(function(){ 
  $("#iddrughide").addClass("hidden");  //vikas june 9 2018
    lastrow=0     // globals
   addheader() 
   addfirstrow()
...
// var keyCode = e.keyCode || e.which;
 ...
 if(e.which == 13) {return}
  ...
  var txtreg='^'+txt
    ...
    var druglength=drugname.length
    ...
    if (document.getElementById(thisid).readOnly) {return}   // if its a blur on a readonly then return
	     if (thisid == "idauth")
            ...
            var last2 = thisid.slice(-2); 
               ...
               if (document.getElementById(thisid).value < 0)     // all others number types mandatoyry must be > 0
                  {      
                  document.getElementById(thisiderr).innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invalid";
 ...
 <form class="form-horizontal" id="fidpur" name="fnmpur" action="" method="post" role="form">           
   <div class="row form-group">
     ...
     <div id="identerpurdt" class="col-sm-2">
       ...
       <!-- june 9 vikas temporary dropdown to store all the drugs.the whole dropdown is copied directly into the drug dropdown of each row -->
