...
//        var insertid=document.getElementById("idreport").firstElementChild.id       
        var temp=$("#"+insertid).find('#idfile').html()
          $("#idfilem").html(temp) 
...
//			        height: 2200
//		        }); 
	//				  CKEDITOR.instances['idfile'].setData(document.getElementById("idfile").innerHTML)
...
//			  CKEDITOR.instances['idfilem'].config.readOnly = true;
//			  CKEDITOR.instances['idfilem'].setReadOnly( isReadOnly );
