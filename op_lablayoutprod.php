...
$ptxtarea = $_POST['ptxtarea']; $patinfo = $_POST['ppatinfo'];$prepdt=$_POST['prepdt']; $pslno=$_POST['pslno'];  
  $refdr=$_POST['prefdr']; 
...
<div class="container">
   <img src="mothersy.gif" class="img-responsive center-block">
...
<!-- start here for adm details--> 
 ...
 <div class=" form-group">
   ...
   <div class="row form-group">
    ...
    <input type="text" id="idsn" name="sn"  class="cshort form-control" value= "<?php echo $pslno; ?>  " readonly >
...
<!-- till here -->    
 <div class="control-group">&nbsp;</div>
    <div class="row  form-group">
     <div id="idrecord">
        <textarea  class="form-control" rows="60" id="idfile" readonly><?php echo $ptxtarea; ?> </textarea>
