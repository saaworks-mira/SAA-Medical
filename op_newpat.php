...
<head>
  ...
  <script src="http://cdnjs.cloudflare.com/ajax/libs/moment.js/2.4.0/lang/en-gb.js"></script>
   <script src="jquery.maskedinput.js" type="text/javascript"></script>2405-->
   ...
   var  errid=elmid+"err";
        var temp=document.getElementById(elmid).value 
         if (temp < flower || temp > fhigher) {
          ...
          document.getElementById(errid).innerHTML = "Invalid , Enter between" + flower +"and" + fhigher 
...
function initallfields() {
    ...
    $(this.id).addClass('hidden')
     ...
     $('#iddobchk,#idname,#sex,#idht,#idwt,#idallergy,#idhistory').val('');
   //   $('#idage').val(0);
      ...
      function(result, status){ 
       ...
       $('#idrecord').removeClass('hidden')
         ...
         // document.getElementById("idname").value=fields.name;
			 document.getElementById("idtextentrypat").value=fields.name;
       
        document.getElementById("iddobchk").value=fields.dob;
...
$(document).on('blur','#idname,#idage,#idsex, #iddob, #idcatg,#idht,#idwt,  #idaddress', function(){   
...
//nov 19 vik
         ...
         if (tempinp.trim().length === 0) {
          ...
          checkfornum = /^\d+$/.test(tempinp); // Matches a string containing only digits
          if (!checkfornum) {
           document.getElementById(thisid).value=0
           document.getElementById(thiserrid).innerHTML = ""
          $('#'+thiserrid).addClass('hidden') 
...
//nov 19
 ...
 //nov 19 vik      if (document.getElementById(thisid).value == "") { 
 //         document.getElementById(thiserrid).innerHTML = ""
 //         $('#'+thiserrid).addClass('hidden')  
 //        return;}
// nov 19 vik
...
$(document).on('click','#idpatbtnconf', function (e) {
    ...
    if (document.getElementById("idpatinpconf").value == "y" || document.getElementById("idpatinpconf").value == "Y") {
        ...
        document.getElementById('idpatinpconf').value = ""
				  var tempinp=document.getElementById("idname").value				
				  if (tempinp.trim().length === 0) {    // nov 19
		//nov 19 vik		 if(document.getElementById("idname").value ==""){					 
	...
	/* nov 19 vik		if(document.getElementById("iddob").value ==""){					 
  ...
  //nov 19 vik
         if (elmht.trim().length === 0) {
           var elmht=0
         }
        else {
       var isNumeric = /^\d+$/.test(elmht); // Matches a string containing only digits
...
//nov 19
 ...
 //nov 19 vik
         if (elmwt.trim().length === 0) {
           var elmwt=0
         }
        else {
         var isNumeric2 = /^\d+$/.test(elmwt); // Matches a string containing only digits
  ...
  //   alert(result)
      ...
      if (!resultdata.succfail) {   // if insert  a problem
        ...
        alert(msg)
         ...
         return;}  
       $('#idpatbtnconf').prop('disabled', false);
       $("#idpatconfrow").addClass('hidden')        // vikas 7/1/2017
       document.getElementById("idpatmsg").innerHTML = resultdata.msg;   // vikas 7/1/2017
       $("#idpatmsgrow").removeClass('hidden')  // vikas 7/1/2017
       $('#iddobchk,#idname,#idage, #iddob, #idht,#idwt, #idallergy,#idhistory,  #idaddress').prop('readonly', true);  // vikas 7/1/2017
         $('#idsex, #idcatg, #idbldgrp').prop('disabled', 'disabled');    // vikas 7/1/2017
        }
 ...
 <div class=" form-group">
   ...
   <div class="row ">
     <div class="col-xs-5 col-sm-10 text-success"><h4 ><strong>First, kindly verify whether Patient Name already exist 
       ...
       <div class="control-group">&nbsp;&nbsp;</div> 
   <div class="row ">
       <div id="idallpat" class="col-sm-offset-1 col-sm-3"> 
    <label for="idtextentrypat" style="color: blue">Patient Name:</label>
      ...
      <select select size="5" id="identrypat"  class="form-control">    
        ...
        <label class="control-label" for="iddobchk">Date of Birth:</label>
     <INPUT type ="text" maxlength="10"  class="form-control" id="iddobchk" name ="nmdobchk">      
     </div> 
     </div>
   </div>
    <div class="control-group">&nbsp;</div> 
   ...
   <div class="row">
    ...
    <label class="control-label" for="idname">Patient Name:</label>
...
<div class="row form-group">        
 ...
 <div id="idpatmsgrow" class="row form-group">
       ...
       <input type="button" name="nmpatbtncont" id="idpatbtncont" class="btn btn-primary" value= "Continue">         
          ...
          <div class="col-sm-2">
			<label class="col-sm-offset-1 radio-inline text-success font20"><input type="radio" id="idradiopharma1" name="optradio1"><strong>OPDPHARMACY</strong></label></div>
 </div>          
