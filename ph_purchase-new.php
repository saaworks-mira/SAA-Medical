...
var temp0='<button type="button" class="btn btn-default btn-sm delete"  style="color:#FF0000;"><span class="glyphicon glyphicon-remove"></span></button>'
 ...
 var temp15='<INPUT type ="number" id="idinp-0115" class="cshort flditem form-control" value=5  ><span class="centerstrong" id="idinp-0115err"></span>'
...
//
      ...
      var stockid="idinp-"+ thisid.slice(-2)+"06" 
   ...
   for(var i = 0; i < (cellcount); i++) {
     ...
     if (temp.indexOf("idsel-") !== -1) {
       ...
       thiscell.innerHTML= element
			 document.getElementById(selrowcol).focus();
     }
       else { 
...
// set min and max values below       
    ...
    lastpriceperpk[drugindx]= vlastpricepur[rowindx]; lastsuppur[drugindx]=vlastsuppur[rowindx];lastdatepur[drugindx]=vlastdatepur[rowindx]; 
    if ((minpricepur[drugindx] == 0) || (minpricepur[drugindx] > vlastpricepur[rowindx])) {        
      vminpricepur[rowindx]= vlastpricepur[rowindx]; vminsuppur[rowindx]=vlastsuppur[rowindx];vmindatepur[rowindx]=vlastdatepur[rowindx];
      minpricepur[drugindx]= vlastpricepur[rowindx]; minsuppur[drugindx]=vlastsuppur[rowindx];mindatepur[drugindx]=vlastdatepur[rowindx];}
     ...
     if ((maxpricepur[drugindx] == 0) || (maxpricepur[drugindx] < vlastpricepur[rowindx])) {        
      vmaxpricepur[rowindx]= vlastpricepur[rowindx]; vmaxsuppur[rowindx]=vlastsuppur[rowindx];vmaxdatepur[rowindx]=vlastdatepur[rowindx];
      maxpricepur[drugindx]= vlastpricepur[rowindx]; maxsuppur[drugindx]=vlastsuppur[rowindx];maxdatepur[drugindx]=vlastdatepur[rowindx];}
