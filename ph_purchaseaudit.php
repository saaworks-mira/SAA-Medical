...
// below variables are retunbed from backend and contains all the drugs         
    var  pqtyperpack=fields.qtyperpack;
		...
		var taxpctid="idinp-"+ thisrowid.slice(-2)+"15" // aug20
...
<hr style="border-top: 5px solid #ff0000 !important; " />
 ...
 <div id="idcontainer" class="container-fluid">
   ...
   <div class="row form-group">
     <div class="col-sm-5 text-success"><h4 ><strong>PURCHASE DETAILS</strong></h4></div> 
		 
		 
     
     <div class="col-xs-offset-4 col-sm-offset-4 col-xs-3 col-sm-3 text-success">
         <a id="rtmn" href="audit.php" > <h4 class="pull-right"><strong>BACK</strong></h4></a>
     </div>
    </div>   
  <div  class="container-fluid">
   ...
   <div class="row form-group">
        <div class="col-sm-offset-2 col-sm-2">
				<!--	<label class="radio-inline text-success font16 "><input type="radio" id="idradioentry"  name="optradio"><a href="loginpurch.php"><strong>PURCHASE ENTRY</strong></a></label></div>-->
          
          
          <div class="col-sm-2">
      <label class="col-sm-offset-1 radio-inline text-success font16"><input type="radio" id="idradioview" checked name="optradio"><strong>PURCHASE VIEW</strong></label></div>
