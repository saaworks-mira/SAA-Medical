      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">MASTER<span class="caret"></span></a>
        ...
        <ul class="dropdown-menu">
         ...
         <li><a href="ph_editdrugmaster.php">EDIT DRUG DETAIL</a></li>
          <li><a href="ph_suppliermaster.php">SUPPLIERS</a></li>
           <li><a href="ph_doctorsmaster.php">DOCTORS</a></li>
       </ul>
     </li>
       ...
       <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">REPORTS<span class="caret"></span></a>
         <ul class="dropdown-menu">
          <li><a href="ph_purchase.php">PURCHASE/VIEW REPORT</a></li>
           ...
           <li><a href="ph_stockreportaudit.php">PHARMACY TRANSACTION  REPORTS</a></li>
              <li><a href="ph_opdstockreportaudit.php">OPD TRANSACTION  REPORTS</a></li>
           <li><a href="ph_opdstockreport.php">OPD STOCK  REPORT</a></li>
           <li><a href="ph_purchase.php">EXPIRY DATE  REPORTS</a></li>
           
           <li><a href="op_viewgenericname.php">GENERIC -BRAND NAME REPORT</a></li>
       </ul>
    . </li>
