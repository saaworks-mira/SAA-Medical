...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/js/bootstrap-datepicker.min.js"></script>2405-->
  ...
  <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>13/5/2019-->
   <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>

  
 <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/js/bootstrap-datepicker.min.js"></script>1505-->
...
//           $('#idallpatientsview').addClass('hidden')
 ...
 // allpatinfo is patid--testid--opddate--ptname--testname--opdid--opdtestid--age--sex         
       ...
       for (var i = 0; i < opdlen; i++) { 
         testnamemod = testnameview[i].replaceAll('/', ''); // added vikas 01/05/2026
       if (!(testnameview[i].includes("CANCER BIOMARKER") || testnameview[i].includes("Iron Deficiency Profile") || testnameview[i].includes("NT-Pro BNP") 
         || testnameview[i].includes("Peripheral Smear"))) 
        {testnamemod = testnamemod.replaceAll(' ', ''); // added vikas 01/05/2026
         testnamemod = testnamemod.replaceAll('-', ''); // added vikas 01/05/2026 
        } 
       testnamemod = testnamemod.replaceAll(',', ''); // added vikas 01/05/2026
       testnamemod = testnamemod.replaceAll('(', ''); // added vikas 01/05/2026
      ...
      var lnk=patientidview[i] +'-' + opddateview[i].substr(6,2)+ opddateview[i].substr(4,2) +
       //   opddateview[i].substr(0,4) + '-' + testnameview[i] +'.html';     vikas 01/05/2026
          opddateview[i].substr(0,4) + '-' + testnamemod +'.html';
            
       var desc='<li class="list-group-item"' + '">'+'<a href="op_modifylab.php?fn='+lnk+ '" id="'+
    // vikas 01/05  patientidview[i] + '-'+ opddateview[i].substr(6,2)+ opddateview[i].substr(4,2)+opddateview[i].substr(0,4) +'-'+ testnameview[i] +  
           patientidview[i] + '-'+ opddateview[i].substr(6,2)+ opddateview[i].substr(4,2)+opddateview[i].substr(0,4) +'-'+ testnamemod + 
     ...
     //  vikas 01/05/2026  patientidview[i] + '-'+ opddateview[i].substr(6,2)+ opddateview[i].substr(4,2)+opddateview[i].substr(0,4) +'-'+ testnameview[i] +  
      patientidview[i] + '-'+ opddateview[i].substr(6,2)+ opddateview[i].substr(4,2)+opddateview[i].substr(0,4) +'-'+ testnamemod +  
...
if (!(filen.includes("CANCER BIOMARKER") || filen.includes("Iron Deficiency Profile") || filen.includes("NT-Pro BNP") 
         || filen.includes("Peripheral Smear"))) 
{  filen = filen.replaceAll('-', ''); // added vikas 01/05/2026
   filen = filen.replaceAll(' ', ''); // added vikas 01/05/2026
} 
filen = filen.replaceAll('/', ''); // added vikas 01/05/2026
filen = filen.replaceAll(',', ''); // added vikas 01/05/2026
