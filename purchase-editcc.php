...
<script type="text/javascript"> 
  ...
  // purchase data below
  var purchasedt=[]; var invoiceno=[]; var vdrugname=[];var vdrugid=[]; var vstrength=[]; var vdrugtype=[]; var pursuppliername=[];
...
function addheader()  {  
  ...
  var descedit='<thead id="idthead"><tr><th class="chead">Edit</th><th>Challan/Inv</th><th>PurchaseDt</th><th>Supplier</th>'+
      '<th>Drug name</th><th>Strength</th><th>Type</th>'
...
// below variables are retunbed from backend and contains all the drugs 
      ...
      vdrugid=fields.drugid; vdrugname=fields.drugname; vstrength=fields.strength; vdrugtype=fields.drugtype 
 ...
 if (elm2save !="") {$(elm2save).prop("disabled",false);}
  ...
  if (saverowid !=thisrowid) {return}  
   var allgood=true;
    ...
    if (!allgood) {alert("invalid input");return}
...
var temp= "input[id$="+rowno+'02],input[id$='+rowno+'03],input[id$='+rowno+'06],input[id$='+rowno+'10],input[id$='+rowno+'11],input[id$='+rowno+'13],input[id$='+rowno+'14],input[id$='+rowno+'16],input[id$='+rowno+'17]';
...
$(document).on('click','#idviewbtnconf',  function(){
   if (document.getElementById("idinpinverror").innerHTML != "") {return}  // already error is there
   var newinvno= document.getElementById("idinpinv").value
   if (newinvno == "") {
        document.getElementById("idinpinverror").innerHTML = "Invalid Invoice";return}  // already error is there
  ...
  <div id="idcontainer" class="container-fluid">
    ...
    <div id="idviewalldrug" class="col-sm-2"> 
     <label>DRUG NAME:</label>
      <INPUT type ="text" id="idtextviewdrug" placeholder="Type Drug Name" class="cvvlong  form-control">
     ...
     <INPUT id="idviewinpexpdt" type="text" maxlength="5" class="cshort form-control fldview" placeholder="mm/yy">
    ...
    <div id="idinvsection" class="row form-group ">              
      ...
      <div class="col-sm-2">       
         <label id="lblinv" class="control-label">ENTER INVOICE NO:</label>
       </div> 
     <div class="col-sm-2">
      <INPUT type ="text" id="idinpinv" placeholder="Enter Invoice:" class="form-control">
       ...
       <INPUT type="button" name="nmpurbtnconf" id="idviewbtnconf" class="btn btn-primary btn-sm"  value= "Confirm">                                                                                 
      </div> 
      <div class="col-sm-1 "> 
        
       <INPUT type="button" name="nmpurbtncan" id="idviewbtncan" class="btn btn-primary btn-sm"  value= "Cancel">                                                                                 
      </div>   
   </div>
